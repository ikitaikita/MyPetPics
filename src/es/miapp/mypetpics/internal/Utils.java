...
public class Utils {
	...
	public static Plantilla obtenerPlantillaAleatoria(ArrayList<Plantilla> listaPlantillas)
	{
		double aleatorio = Math.floor(Math.random()*listaPlantillas.size());
		Plantilla seleccion = listaPlantillas.get((int) aleatorio);
		return seleccion;
		
	}
	 
	public static String obtenerAleatorio(ArrayList<String> listaEntrada)
	{
		
		double aleatorio = Math.floor(Math.random()*listaEntrada.size());
		String seleccion = listaEntrada.get((int) aleatorio);
		return seleccion;
